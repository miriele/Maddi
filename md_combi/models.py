...
class MdComb(models.Model):
    ...
    comb_img = models.ImageField(max_length=100, blank=True, null=True, db_comment='이미지경로')
...
class MdCombM(models.Model):
    ...
    comb = models.ForeignKey(MdComb, models.DO_NOTHING, db_comment='추천조합ID')
    menu = models.ForeignKey('md_store.MdMenu', models.DO_NOTHING, db_comment='메뉴ID')
